# updated see.genes.kh function: by Karolina Heyduk and G. Young Kim
...
see.genes.kh<-function (data, edesign = data$edesign, time.col = 1, repl.col = 2,
                        ...
                        m = 1.07, cluster.method = "hclust", distance = "cor", agglo.method = "ward.D",
                        ...
                        cexlab = 1, legend = TRUE, newX11 = FALSE, ylim = NULL, main = NULL,
                        ...)
{
